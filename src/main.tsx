...
function App(){
  ...
  useEffect(()=>{
    ...
    const initialize = async()=>{
      ...
      if(error){
        /*
         * Guests do not have a Supabase auth session.
         * This is expected and must NOT stop the public
         * caregiver search from loading.
         */
        console.info('No auth session; continuing as guest.',error.message);
      }
  ...
  async function loadCaregivers(){
    ...
    try{
      ...
      /* Supabase is authoritative. Never keep demo caregivers. */
